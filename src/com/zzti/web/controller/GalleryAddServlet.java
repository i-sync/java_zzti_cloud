...
/**
 * Servlet implementation class GalleryAddServlet
 */
@WebServlet("/GalleryAddServlet")
public class GalleryAddServlet extends HttpBaseServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpBaseServlet#HttpBaseServlet()
     */
    public GalleryAddServlet() {
        super();
