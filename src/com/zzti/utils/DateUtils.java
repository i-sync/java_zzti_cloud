...
public class DateUtils {
	...
	public static int getIntervalDays(Date date, Date otherDate) {
		...
		Date otherDateTmp = DateUtils.StringToDate(
				DateUtils.getDate(otherDate), DateStyle.YYYY_MM_DD);
	...
	/**
	 * 把日期转换成XMLGregorianCalendar
	 * @param date
	 * @return
	 */
	public static XMLGregorianCalendar dateToXMLGregorianCalender(Date date) {
